...
# Argument parsing
parser = argparse.ArgumentParser(description="Convert PyTorch model to TensorFlow.js format")
...
tfjs.converters.save_keras_model(tf_actor_model, f"tfjs_pytorch_actor")
