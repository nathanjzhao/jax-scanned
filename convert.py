...
def create_actor_critic_model(input_dim, action_dim, activation='tanh'):
    ...
    actor_model = tf.keras.Sequential([
        ...
        tf.keras.layers.Dense(256, activation=activation_fn, kernel_initializer=tf.keras.initializers.Orthogonal(np.sqrt(2)), bias_initializer='zeros', name='actor_dense1'),
        tf.keras.layers.Dense(256, activation=activation_fn, kernel_initializer=tf.keras.initializers.Orthogonal(np.sqrt(2)), bias_initializer='zeros', name='actor_dense2'),
        tf.keras.layers.Dense(action_dim, kernel_initializer=tf.keras.initializers.Orthogonal(0.01), bias_initializer='zeros', name='actor_mean')
    ])
